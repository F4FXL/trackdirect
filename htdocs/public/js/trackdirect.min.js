...
trackdirect.services.stationColorCalculator={_colors:["#00558C","#F97706","#F7D83C","#569119","#8D1734","#8BC4E8","#595E09","#B7C20A","#53216A","#F78B05","#EA221B","#F79038",],_stationColorId:{},getColor:function(packet,trimmed=false){let colorId=this.getColorId(packet);if(trimmed===false)

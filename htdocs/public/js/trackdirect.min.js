...
return null;},getColorId:function(packet){let colorId;if(packet.station_name in this._stationColorId){colorId=this._stationColorId[packet.station_name];return colorId;}else{let hash=this._simplehashStr(packet.station_name);colorId=Math.abs(hash)%this._colors.length;console.log("Hash "+hash+" Id "+colorId);this._stationColorId[packet.station_name]=colorId;}
